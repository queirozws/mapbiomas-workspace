...
// var filtered = products.filter(function(obj) {return obj.initiative === "brazil" || obj.collection === 1 } )

function selectAssets(obj) {
    
    return (obj.initiative === this.initiative || obj.collection === this.collection)
